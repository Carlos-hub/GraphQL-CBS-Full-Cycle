...
func (ec *executionContext) _Category_courses(ctx context.Context, field graphql.CollectedField, obj *model.Category) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOCourse2ᚕᚖgithubᚗcomᚋdevfullcycleᚋ13ᚑGraphQLᚋgraphᚋmodelᚐCourseᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOCourse2ᚕᚖgithubᚗcomᚋdevfullcycleᚋ13ᚑGraphQLᚋgraphᚋmodelᚐCourseᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Course) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
